...
upstream_package_to_debian_binary_name = (
    _upstream_ontologist.debian.upstream_package_to_debian_binary_name  # type: ignore
)
...
upstream_name_to_debian_source_name = (
    _upstream_ontologist.debian.upstream_name_to_debian_source_name  # type: ignore
)
