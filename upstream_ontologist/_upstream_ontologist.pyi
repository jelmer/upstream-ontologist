...
def guess_from_debian_watch(path: str, trust_package: bool) -> Iterator[UpstreamDatum]: ...
def guess_from_debian_changelog(path: str, trust_package: bool) -> Iterator[UpstreamDatum]: ...
...
def guess_from_get_orig_source(path: str, trust_package: bool) -> Iterator[UpstreamDatum]: ...
