...
def guess_from_debian_rules(
    path: str, trust_package: bool) -> Iterator[UpstreamDatum]: ...
def guess_from_debian_changelog(
    path: str, trust_package: bool
) -> Iterator[UpstreamDatum]: ...
...
def guess_from_package_yaml(
    path: str, trust_package: bool
) -> Iterator[UpstreamDatum]: ...
def guess_from_wscript(path: str, trust_package: bool) -> Iterator[UpstreamDatum]: ...
def guess_from_git_config(
    path: str, trust_package: bool
) -> Iterator[UpstreamDatum]: ...
def guess_from_security_md(
    path: str, trust_package: bool
) -> Iterator[UpstreamDatum]: ...
def guess_from_metadata_json(
    path: str, trust_package: bool
) -> Iterator[UpstreamDatum]: ...
def guess_from_pyproject_toml(
    path: str, trust_package: bool
) -> Iterator[UpstreamDatum]: ...
...
def guess_from_package_json(
    path: str, trust_package: bool
) -> Iterator[UpstreamDatum]: ...
def guess_from_package_xml(
    path: str, trust_package: bool
) -> Iterator[UpstreamDatum]: ...
def guess_from_perl_module(
    path: str, trust_package: bool
) -> Iterator[UpstreamDatum]: ...
def guess_from_perl_dist_name(
    path: str, trust_package: bool
) -> Iterator[UpstreamDatum]: ...
...
def guess_from_get_orig_source(
    path: str, trust_package: bool
) -> Iterator[UpstreamDatum]: ...
...
def guess_from_install(path: str, trust_package: bool) -> Iterator[UpstreamDatum]: ...
def guess_from_readme(path: str, trust_package: bool) -> Iterator[UpstreamDatum]: ...
...
def fixup_broken_git_details(url: str, branch: str | None = None, subpath: str | None = None) -> (str, str | None, str | None): ...
